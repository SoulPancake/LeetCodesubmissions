    ...
    private long helper(int remChars,char previousCharacter)
    {
        ...
        switch(previousCharacter){
            ...
            case 'e':total=(helper(remChars-1,'a')+helper(remChars-1,'i'))%mod;
                break;
            case 'i':total=(helper(remChars-1,'a')+helper(remChars-1,'e')+helper(remChars-1,'o')+helper(remChars-1,'u'))%mod;
                break;
            case 'o':total=(helper(remChars-1,'i')+helper(remChars-1,'u'))%mod;
                break;
