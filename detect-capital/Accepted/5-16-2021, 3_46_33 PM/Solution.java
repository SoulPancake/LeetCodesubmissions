...
class Solution {
    public boolean detectCapitalUse(String word) {
       ...
       for(int i=0;i<word.length();i++)
       {
        ...
        if(count==1 && Character.isUpperCase(word.charAt(0))) //First uppercase
            return true;                                      //Rest lowercase
    ...
    public boolean checkFirstUpperRestLower(String word) //Self-Explanatory
    {
